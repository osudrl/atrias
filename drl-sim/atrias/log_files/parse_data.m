...
zero_buffer_vector = zeros(BUFFER_ZEROS, 1);
negative_buffer_time = -[1:BUFFER_ZEROS];
positive_buffer_time = [1:BUFFER_ZEROS];
...
for iter = [1:num_files]
    ...
    profile_time = [1:numel(desired_profileA)]';
    
    
    plot(profile_time*0.001, desired_profileA, 'b-', [1:numel(desired_profileB)]*0.001, -desired_profileB, 'r-', [1:numel(desired_profileB)]*0.001, mean([desired_profileA'; -desired_profileB']),'g-')
