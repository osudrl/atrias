...
DataLogger::DataLogger( const char *filename )
{
	...
	// Create file header.
	fprintf( fp, "Body Angle, Motor Angle A, Motor Angle B, Leg Angle A, Leg Angle B, Body Angular Velocity, Motor Velocity A, Motor Velocity B, Leg Velocity A, Leg Velocity B, Height, Horizontal Velocity, Vertical Velocity, Motor Torque A, Motor Torque B, Counter\n");		
}
...
void DataLogger::log( DataToUspace *data )
{
	fprintf( fp, "%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %u\n", data->controller_input.body_angle, data->controller_input.motor_angleA, data->controller_input.motor_angleB,
		...
		data->controller_output.motor_torqueA, data->controller_output.motor_torqueB, data->cnt );
}
