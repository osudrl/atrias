...
#define DELTA_Y (0.5*sin(ad.motor_angleB) + 0.5*sin(ad.motor_angleA))
#define DELTA_X (-0.5*cos(ad.motor_angleB) - 0.5*cos(ad.motor_angleA))
...
void visCallback(const atrias_msgs::atrias_data &atriasData) {
    ad = atriasData;
    draw_leg();
}
...
int main (int argc, char **argv) {
    ...
    atrias_gui_sub = nh.subscribe("atrias_data_50_hz", 0, visCallback);
    atrias_gui_pub = nh.advertise<atrias_msgs::atrias_controller_requests>("atrias_controller_requests", 10);

    cr.command = CMD_DISABLE;
    cr.controller_requested = 0;
...
void restart_robot (void) {
    if (cr.command == CMD_DISABLE) {
        cr.command = CMD_RESTART;
        cr.controller_requested = NO_CONTROLLER;
...
void switch_controllers (GtkNotebookPage* page, guint page_num) {
    if (cr.command == CMD_DISABLE)
        cr.controller_requested = page_num;
    else
        controller_notebook->set_current_page(cr.controller_requested);
...
bool poke_controller (void) {
    ros::spinOnce();
    char buffer[20];
    switch (cr.controller_requested) {
        case NO_CONTROLLER:
            //MTR_TRQ_CONTROLLER_DATA(&(cr.control_data.elems))->mtr_trqA = 0.;
            break;
        case MOTOR_TORQUE_CONTROLLER:
            ((MtrTrqControllerData *) (&(cr.control_data.elems)))->mtr_trqA = motor_torqueA_hscale->get_value();
            ((MtrTrqControllerData *) (&(cr.control_data.elems)))->mtr_trqB = motor_torqueB_hscale->get_value();
            ((MtrTrqControllerData *) (&(cr.control_data.elems)))->mtr_trq_hip = motor_torque_hip_hscale->get_value();
            break;
        case MOTOR_POSITION_CONTROLLER:
            ((MtrPosControllerData *) (&(cr.control_data.elems)))->mtr_angA = motor_positionA_hscale->get_value();
            ((MtrPosControllerData *) (&(cr.control_data.elems)))->mtr_angB = motor_positionB_hscale->get_value();
            ((MtrPosControllerData *) (&(cr.control_data.elems)))->p_gain = p_motor_position_hscale->get_value();
            ((MtrPosControllerData *) (&(cr.control_data.elems)))->d_gain = d_motor_position_hscale->get_value();
            break;
        case LEG_TORQUE_CONTROLLER:
            ((LegTrqControllerData *) (&(cr.control_data.elems)))->leg_ang_trq = leg_angle_torque_hscale->get_value();
            ((LegTrqControllerData *) (&(cr.control_data.elems)))->leg_len_trq = leg_length_torque_hscale->get_value();
            break;
        case LEG_POSITION_CONTROLLER:
            ((LegPosControllerData *) (&(cr.control_data.elems)))->leg_len = leg_length_hscale->get_value();
            ((LegPosControllerData *) (&(cr.control_data.elems)))->leg_ang = leg_angle_hscale->get_value();
            ...
            ((LegPosControllerData *) (&(cr.control_data.elems)))->p_gain = p_leg_position_hscale->get_value();
            ((LegPosControllerData *) (&(cr.control_data.elems)))->d_gain = d_leg_position_hscale->get_value();
            ((LegPosControllerData *) (&(cr.control_data.elems)))->hip_ang = hip_position_ang->get_value();
            ((LegPosControllerData *) (&(cr.control_data.elems)))->hip_p_gain = hip_position_p->get_value();
            ((LegPosControllerData *) (&(cr.control_data.elems)))->hip_d_gain = hip_position_d->get_value();
            break;
        case SINE_WAVE_CONTROLLER:
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->leg_ang_frq = leg_angle_frequency_hscale->get_value();
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->leg_ang_amp = leg_angle_amplitude_hscale->get_value();
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->leg_len_frq = leg_length_frequency_hscale->get_value();
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->leg_len_amp = leg_length_amplitude_hscale->get_value();
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->p_gain = p_sine_wave_hscale->get_value();
            ((SinWaveControllerData *) (&(cr.control_data.elems)))->d_gain = d_sine_wave_hscale->get_value();
            break;
        case RAIBERT_CONTROLLER:
            ((RaibertControllerData *) (&(cr.control_data.elems)))->des_hor_vel = raibert_desired_velocity_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->des_hop_ht = raibert_desired_height_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->hor_vel_gain = raibert_hor_vel_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->hop_ht_gain = raibert_leg_force_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->leg_ang_gain = raibert_leg_angle_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->stance_p_gain = raibert_stance_p_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->stance_d_gain = raibert_stance_d_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->stance_spring_threshold = raibert_stance_spring_threshold_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->preferred_leg_len = raibert_preferred_leg_len_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->flight_p_gain = raibert_flight_p_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->flight_d_gain = raibert_flight_d_gain_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->flight_spring_threshold = raibert_flight_spring_threshold_spinbutton->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->stance_hip_p_gain = raibert_stance_hip_p_gain->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->stance_hip_d_gain = raibert_stance_hip_d_gain->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->flight_hip_p_gain = raibert_flight_hip_p_gain->get_value();
            ((RaibertControllerData *) (&(cr.control_data.elems)))->flight_hip_d_gain = raibert_flight_hip_d_gain->get_value();

            // Set the state label.
            if (ad.status == CMD_DISABLE)
                raibert_state_label->set_label("Disabled");
            else
                if (((RaibertControllerState *) (&(ad.control_state.elems)))->in_flight)
                raibert_state_label->set_label("Flight");
            else
                raibert_state_label->set_label("Stance");
            break;
        case HUBICKI_CONTROLLER:
            ((HubickiControllerData *) (&(cr.control_data.elems)))->des_hor_vel = hubicki_desired_velocity_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->des_hop_ht = hubicki_desired_height_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->hor_vel_gain = hubicki_hor_vel_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->hop_ht_gain = hubicki_leg_force_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->leg_ang_gain = hubicki_leg_angle_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->stance_p_gain = hubicki_stance_p_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->stance_d_gain = hubicki_stance_d_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->stance_spring_threshold = hubicki_stance_spring_threshold_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->preferred_leg_len = hubicki_preferred_leg_len_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->flight_p_gain = hubicki_flight_p_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->flight_d_gain = hubicki_flight_d_gain_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->flight_spring_threshold = hubicki_flight_spring_threshold_spinbutton->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->stance_hip_p_gain = hubicki_stance_hip_p_gain->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->stance_hip_d_gain = hubicki_stance_hip_d_gain->get_value();
            ((HubickiControllerData *) (&(cr.control_data.elems)))->flight_hip_p_gain = hubicki_flight_hip_p_gain->get_value();
        ...
        case TEST_CONTROLLER:
            ((TestControllerData *) (&(cr.control_data.elems)))->flightKP = test_slider_flightKP->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->flightKD = test_slider_flightKD->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->stanceKP = test_slider_stanceKP->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->stanceKD = test_slider_stanceKD->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->desiredLengthLong = test_slider_desiredLengthLong->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->desiredLengthShort = test_slider_desiredLengthShort->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->toeSwitchThreshold = test_slider_toeSwitchThreshold->get_value();
            ((TestControllerData *) (&(cr.control_data.elems)))->springDeflectionThreshold = test_slider_springDeflectionThreshold->get_value();

            test_slider_springDeflectionA->set_value(((TestControllerState *) (&(ad.control_state.elems)))->springDeflectionAverageAOld);
            test_slider_springDeflectionB->set_value(((TestControllerState *) (&(ad.control_state.elems)))->springDeflectionAverageBOld);

            if (((TestControllerState *) (&(ad.control_state.elems)))->currentState > 0) {
	...
	case FORCE_CONTROLLER:
	    ((ForceControllerData *) (&(cr.control_data.elems)))->p_gainA = force_control_p_gainA->get_value();
            ((ForceControllerData *) (&(cr.control_data.elems)))->d_gainA = force_control_d_gainA->get_value();
            ((ForceControllerData *) (&(cr.control_data.elems)))->i_gainA = force_control_i_gainA->get_value();
	    ((ForceControllerData *) (&(cr.control_data.elems)))->p_gainB = force_control_p_gainB->get_value();
    ...
    atrias_gui_pub.publish(cr);

    // Move the sliders if the controller is disabled.
    if (ad.status == CMD_DISABLE) {
        motor_positionA_hscale->set_value(ad.motor_angleA);
        motor_positionB_hscale->set_value(ad.motor_angleB);
    }

    // Update the motor torque progress bars and displays.
    sprintf(buffer, "%0.4f", ad.motor_torqueA);
    ...
    sprintf(buffer, "%0.4f", ad.xPosition);
    xPosDisplay->set_text(buffer);
    sprintf(buffer, "%0.4f", ad.yPosition);
    yPosDisplay->set_text(buffer);
    sprintf(buffer, "%0.4f", ad.zPosition);
    zPosDisplay->set_text(buffer);

    sprintf(buffer, "%0.4f", ad.xVelocity);
    xVelDisplay->set_text(buffer);
    sprintf(buffer, "%0.4f", ad.yVelocity);
    yVelDisplay->set_text(buffer);
    sprintf(buffer, "%0.4f", ad.zVelocity);
    zVelDisplay->set_text(buffer);

    /* Update Medulla status */
    sprintf(buffer,"%0.2f",ad.thermistorA[0]);
    MedullaA_TempA->set_text(buffer);

    sprintf(buffer,"%0.2f",ad.thermistorA[1]);
    MedullaA_TempB->set_text(buffer);

    sprintf(buffer,"%0.2f",ad.thermistorA[2]);
    MedullaA_TempC->set_text(buffer);

    sprintf(buffer,"%0.1f",ad.motorVoltageA);
    MedullaA_VMotor->set_text(buffer);

    sprintf(buffer,"%0.1f",ad.logicVoltageA);
    MedullaA_VLogic->set_text(buffer);

    sprintf(buffer,"%0.2f",ad.thermistorB[0]);
    MedullaB_TempA->set_text(buffer);

    sprintf(buffer,"%0.2f",ad.thermistorB[1]);
...
void draw_leg () {
    ...
    // A
    cc->rel_line_to(short_segment_length * cos(ad.leg_angleA), -short_segment_length * sin(ad.leg_angleA));
    // C
    cc->rel_line_to(segment_length * cos(ad.leg_angleB), -segment_length * sin(ad.leg_angleB));
    // B
    cc->move_to(start_x, start_y);
    cc->rel_line_to(segment_length * cos(ad.leg_angleB), -segment_length * sin(ad.leg_angleB));
    // D
    cc->rel_line_to(segment_length * cos(ad.leg_angleA), -segment_length * sin(ad.leg_angleA));
    cc->stroke();
    ...
    // A
    cc->move_to(start_x, start_y);
    cc->rel_line_to(motor_radius * cos(ad.motor_angleA), -motor_radius * sin(ad.motor_angleA));
    cc->move_to(start_x, start_y);
    cc->rel_line_to(-motor_radius * cos(ad.motor_angleA), motor_radius * sin(ad.motor_angleA));
    // B
    cc->move_to(start_x, start_y);
