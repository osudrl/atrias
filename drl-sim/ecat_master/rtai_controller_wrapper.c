...
int __init init_mod(void)
{
	...
	// To Uspace SHM
	to_uspace_shm = (DataToUspace *)rt_shm_alloc( SHM_TO_USPACE_KEY, SHM_TO_USPACE_ENTRIES * sizeof(DataToUspace), USE_VMALLOC );
	if (to_uspace_shm == NULL)
		return -ENOMEM;
	memset(to_uspace_shm, 0, SHM_TO_USPACE_ENTRIES * sizeof(DataToUspace));
