...
uControllerInput			*medulla_boom;
uControllerInput			*medulla_B;
uControllerInput			*medulla_A;
uControllerInput			*medulla_hip;
...
unsigned char		state 		= WAKE_UP;
unsigned char		next_state 	= WAKE_UP;
