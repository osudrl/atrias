...
static ec_pdo_entry_info_t medulla_rxpdo_entries[NUM_OF_MEDULLAS];
static ec_pdo_entry_info_t medulla_txpdo_entries[NUM_OF_MEDULLAS];

static ec_pdo_info_t medulla_rx_pdos[NUM_OF_MEDULLAS];
static ec_pdo_info_t medulla_tx_pdos[NUM_OF_MEDULLAS];
