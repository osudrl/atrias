...
int main(int argc, char **argv)
{
  ...
  // NEW
  gui->get_widget("extra_1_line_1_object", extra_1_line_1_object);
  gui->get_widget("extra_1_line_2_object", extra_1_line_2_object);
  gui->get_widget("extra_1_line_3_object", extra_1_line_3_object);
  gui->get_widget("extra_1_line_4_object", extra_1_line_4_object);
  gui->get_widget("extra_1_line_5_object_1", extra_1_line_5_object_1);
  gui->get_widget("extra_1_line_5_object_2", extra_1_line_5_object_2);
  gui->get_widget("extra_1_line_5_object_3", extra_1_line_5_object_3);
  gui->get_widget("extra_1_line_5_object_4", extra_1_line_5_object_4);
  // END NEW
  ...
  /*
  //NEW
  Gtk::Adjustment extra_1_adjustment = new Gtk::Adjustment(0.0, -10.0, 10.0, 0.01, 5.0, 5.0);
  extra_1_line_1_object->set_adjustment(extra_1_adjustment);
  extra_1_line_2_object->set_adjustment(extra_1_adjustment);
  extra_1_line_3_object->set_range(-10., 10.);
  extra_1_line_4_object->set_range(-10., 10.);
  //END NEW
  */
