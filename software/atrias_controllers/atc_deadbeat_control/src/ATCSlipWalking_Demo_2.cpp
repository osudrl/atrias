    ...
    ascRateLimitRr0(this, "ascRateLimitRr0")
{
    ...
    // Hamid
    // Upload the LUT here:
    // ifstream TwoStepTDangle
    // TwoStepTDangle.open("TwoStepTDangle.txt");
...
void ATCSlipWalking::updateController() {
    ...
    // Hamid:
    // check if the position of the system is in Poincare section
    // q1 = TwoStepPolicyTD();
    // q2 = TwoStepPolicyTD();
...
void ATCSlipWalking::stanceController(atrias_msgs::robot_state_leg *rsSl, atrias_msgs::controller_output_leg *coSl, ASCLegForce *ascLegForceSl, ASCRateLimit *ascRateLimitSr0) {
    ...
    // assume the force is from linear spring and the projection to CoM causes 12000 N/m
    //
    // fa = 12000 * (rSl - r0Sl);
    // dfa = 12000 * (drSl);
    // rvpp = 0;
