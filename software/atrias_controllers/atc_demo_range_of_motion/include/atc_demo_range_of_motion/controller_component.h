...
#define LEG_DEMO_SAFE_DIST (LEG_LOC_SAFETY_DISTANCE+0.1)
...
private:
    ...
    // Current desired motor states (which may be autogenerated!)
    ...
    // Target motor angles of automated demo.
    double la, lb, lh, ra, rb, rh;
