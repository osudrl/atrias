...
atrias_msgs::controller_output ATCDemoRangeOfMotion::runController(atrias_msgs::robot_state rs) {
    ...
    co.lLeg.motorCurrentHip = pd2RunController(desLeftHipState.ang,  rs.lLeg.hip.legBodyAngle, desLeftHipState.vel,  rs.lLeg.hip.legBodyVelocity);
    ...
    co.rLeg.motorCurrentHip = pd2RunController(desRightHipState.ang, rs.rLeg.hip.legBodyAngle, desRightHipState.vel, rs.rLeg.hip.legBodyVelocity);
