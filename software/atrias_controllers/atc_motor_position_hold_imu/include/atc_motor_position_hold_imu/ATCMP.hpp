...
#include "atc_motor_position_hold_imu/controller_log_data.h"
// The type transmitted from the GUI to the controller
#include "atc_motor_position_hold_imu/controller_input.h"
// The type transmitted from the controller to the GUI
#include "atc_motor_position_hold_imu/controller_status.h"
...
using namespace std;
using namespace atc_motor_position_hold_imu;
 ...
 */
class ATCMP : public ATC<atc_motor_position_hold_imu::controller_log_data_, controller_input_, controller_status_> {
	public:
		/**
