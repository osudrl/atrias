...
bool guiInit(Glib::RefPtr<Gtk::Builder> gui) {
    ...
    slip_height_spinbutton->set_range(0., 100.);
    slip_mass_spinbutton->set_range(0., 100.);
    slip_spring_spinbutton->set_range(0., 100.);

    // Set default values
    flight_leg_P_gain_spinbutton->set_value(0.);
    flight_leg_D_gain_spinbutton->set_value(0.);
    flight_hip_P_gain_spinbutton->set_value(0.);
    flight_hip_D_gain_spinbutton->set_value(0.);
    stance_leg_P_gain_spinbutton->set_value(0.);
    stance_leg_D_gain_spinbutton->set_value(0.);
    stance_hip_P_gain_spinbutton->set_value(0.);
    stance_hip_D_gain_spinbutton->set_value(0.);
    slip_height_spinbutton->set_value(0.);
    slip_mass_spinbutton->set_value(0.);
    slip_spring_spinbutton->set_value(0.);
