...
#include <atc_slip_running/controller_gui.h>
...
bool guiInit(Glib::RefPtr<Gtk::Builder> gui) {
    ...
    sub = nh.subscribe("atc_slip_running_status", 0, controllerCallback);
    pub = nh.advertise<atc_slip_running::controller_input>("atc_slip_running_input", 0);
    return true;
...
// controllerCallback ==========================================================
void controllerCallback(const atc_slip_running::controller_status &status) {
