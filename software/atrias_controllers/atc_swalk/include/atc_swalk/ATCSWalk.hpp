...
#include "atc_swalk/controller_log_data.h"
 ...
 * data to the GUI:
 *     class ATCSWalk : public ATC<log_data, gui_to_controller,>
 *
 * Here, we don't need any log data, but we do communicate both ways w/ the GUI
 */
class ATCSWalk : public ATC<atc_swalk::controller_log_data_, controller_input_, controller_status_> {
	public:
		/**
