...
MODEL                   = vc_controller_2
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c vc_controller_2_data.c 
MAKEFILE                = vc_controller_2.mk
MATLAB_ROOT             = /afs/engin.umich.edu/caen/rhel_6/matlab-2012a
ALT_MATLAB_ROOT         = /afs/engin.umich.edu/caen/rhel_6/matlab-2012a
MASTER_ANCHOR_DIR       = 
START_DIR               = /afs/umich.edu/user/b/g/bgbuss/Private/Research/Biped/code/complinat_ground
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/vc_controller_2_ert_shrlib_rtw \
	-I$(START_DIR) \
